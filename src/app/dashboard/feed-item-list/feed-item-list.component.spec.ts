...
describe('FeedItemListComponent', () => {
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      ...
      declarations: [FeedItemListComponent, FeedItemComponent, TransformToUntilDatePipe],
    }).compileComponents();
  }));
  ...
  it('should defined one FeedItemComponent', () => {
    component.feedItems = mockFeedItems;
    feedItemListFixture.detectChanges();
    const feedItemComponentList = feedItemListFixture.debugElement.queryAll(By.directive(FeedItemComponent));

    expect(feedItemComponentList.length).toBe(1);
  });
});
